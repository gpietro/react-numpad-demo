  ...
  return (
    <Grid container>
      <Grid item xs={12} style={{ textAlign: "center" }}>
        ...
        <h2 className="display-4">{`React Numpad (v.${
          packageJson.dependencies["react-numpad"]
        })`}</h2>
        <GoLogoGithub
          onClick={() =>
            (window.location = "https://github.com/gpietro/react-numpad")
          }
          ...
          <CardContent>
            ...
            <Grid container alignItems="center">
              ...
              <Grid item sm xs={12}>
                <NumPad.Number
                  onChange={value =>
                    dispatch({ type: "positive.number", value })
                  }
                  theme="orange"
                  negative={false}
              ...
              <Grid item sm xs={12}>
                <NumPad.Number
                  onChange={value =>
                    dispatch({ type: "integer.number", value })
                  }
                  decimal={false}
            ...
            <Grid container alignItems="center">
              <Grid item sm xs={12}>
                <NumPad.Calendar
                  ...
                  locale="it"
                  onChange={value =>
                    dispatch({ type: "italian.calendar", value })
                  }
                >
                  <TextField
              ...
              <Grid item sm xs={12}>
                <NumPad.Calendar
                  onChange={value =>
                    dispatch({ type: "default.calendar", value })
                  }
                >
                  <TextField
              ...
              <Grid item sm xs={12}>
                <NumPad.Calendar
                  onChange={value =>
                    dispatch({ type: "markers.calendar", value })
                  }
                  dateFormat="DD.MM.YYYY"
                  markers={[
                    moment()
            ...
            <Grid container alignItems="center">
              <Grid item sm xs={12}>
                <NumPad.Appointment
                  ...
                  position={"startTopLeft"}
                  onChange={value =>
                    dispatch({ type: "any.appointment", value })
                  }
                >
                  <TextField
                    label="Appuntamento"
              ...
              <Grid item sm xs={12}>
                <NumPad.Appointment
                  ...
                  dates={appointmentDates}
                  onChange={value =>
                    dispatch({ type: "fullscreen.appointment", value })
                  }
                >
                  <TextField
                    label="Fullscreen"
